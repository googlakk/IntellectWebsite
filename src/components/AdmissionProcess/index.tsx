...
const AdmissionProcess = () => {
  const t = useTranslations('AdmissionProcess')
  ...
  const icons = [
    ...
    },
    {
      icon: (
        ...
        >
          <path
            d="M12 15L12 19M12 19L9 16M12 19L15 16M9 10V6C9 4.34315 10.3431 3 12 3C13.6569 3 15 4.34315 15 6V10M7 21H17C18.1046 21 19 20.1046 19 19V11C19 9.89543 18.1046 9 17 9H7C5.89543 9 5 9.89543 5 11V19C5 20.1046 5.89543 21 7 21Z"
            stroke="currentColor"
            strokeWidth="1.5"
            strokeLinecap="round"
            strokeLinejoin="round"
    ...
    },
    {
      icon: (
        ...
        >
          <path
            d="M17 16V18C17 19.1046 16.1046 20 15 20H5C3.89543 20 3 19.1046 3 18V16M21 12V6C21 4.89543 20.1046 4 19 4H8C6.89543 4 6 4.89543 6 6V12M21 12L12 17L3 12M12 17V8"
            stroke="currentColor"
            strokeWidth="1.5"
            strokeLinecap="round"
            strokeLinejoin="round"
    ...
    },
    {
      icon: (
        ...
        >
          <path
            d="M9 13H15M9 17H12M9 9H12M19 21H5C3.89543 21 3 20.1046 3 19V5C3 3.89543 3.89543 3 5 3H14.1716C14.702 3 15.2107 3.21071 15.5858 3.58579L20.4142 8.41421C20.7893 8.78929 21 9.29799 21 9.82843V19C21 20.1046 20.1046 21 19 21Z"
            stroke="currentColor"
            strokeWidth="1.5"
            strokeLinecap="round"
            strokeLinejoin="round"
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (phoneDigits.length !== 9) {
        alert(t('alerts.phoneError'))
        phoneInputRef.current?.focus()

        return
      }

      await Api.email.EmailSendForParents(formData)
  ...
  const documents = t.raw('documents.list') as string[]
    ...
    <section className="py-12 mt-28">
      <div className="container mx-auto px-4 mt-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          >
            <h3 className="text-xl font-bold mb-4">{t('application.title')}</h3>
            <p className="mb-6 text-blue-100">{t('application.description')}</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              >
                {submitted
                  ? t('application.form.loadingButton')
                  : t('application.form.submitButton')}
              </button>
            </form>
          </motion.div>
        </div>
